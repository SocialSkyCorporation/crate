...
public final class PgFunctionIsVisible {
    ...
    public static void register(ScalarFunctionModule module) {
        module.register(
            ...
            (signature, boundSignature) -> new Scalar<Boolean, Integer>() {
                ...
                public Boolean evaluate(TransactionContext txnCtx, Input<Integer>... args) {
                    ...
                    return funcOid != null && module.getFunctionSignatureByOid(funcOid) != null;
                }
            }
        );
    }
